...
import com.law.community.chche.TagCache;
...
//    }
    //屏蔽敏感词
    title = new KeywordFilter().filter(title);
    description = new KeywordFilter().filter(description);
    tag = new KeywordFilter().filter(tag);
